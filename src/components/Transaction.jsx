...
const Transaction = () => {
    ...
    return (
        <div className=' flex flex-col gap-4'>
            ...
            <div className="bg-white flex flex-col w-full overflow-x-auto gap-4 mb-7 rounded-large" style={{ padding: '30px 30px 30px 30px' }}>
                                    ...
                                    return (
                                        <th
                                            ...
                                            <input class="allSelector" id="allSelector" type="checkbox" onClick={handleAllSelection}
                                                style={{ transform: "translateY(8%)", lineHeight: 'unset', verticalAlign: 'top', marginTop: '-7px', marginLeft: '2px' }} />
                                        </th>
                                    )
                                else
                                    return (
