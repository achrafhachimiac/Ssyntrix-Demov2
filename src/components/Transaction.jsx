...
const Transaction = () => {
  ...
  return (
    <div className=" flex flex-col gap-4">
      <div
        className="bg-white flex flex-col w-full overflow-x-auto gap-4 rounded-large"
        ...
        <div className="flex flex-col  gap-4 p-2">
          <div className="flex flex-row gap-2 justify-between">
            <div className="flex flex-col w-[23%] ">
              <label
                className="bg-blue-custom mb-[2px] text-white pr-1 pl-1 text-sm rounded-[4px] w-fit"
                for="TransactionID"
              >
                Transaction ID
              </label>
              <input
                type="text"
                className="border-1 rounded-large p-1"
                name="transactions"
                id="TransactionID"
            ...
            <div className="flex flex-col w-[23%]">
              ...
              <div className="flex justify-between">
                <input
                  className="border-1 w-[40%]  rounded-large p-1"
                  id="Amount"
                  placeholder="Min"
                ></input>
                <span className="flex items-center">
                  {" "}
                  <FaArrowsAltH size={28} />{" "}
                </span>
                <input
                  className="border-1 w-[40%]  rounded-large p-1"
                  id="Amount"
          ...
          <div className="flex flex-row gap-2 justify-between">
            ...
            <div className="flex flex-col w-[23%]">
              <label
                className="bg-blue-custom mb-[2px] text-white pr-1 pl-1 text-sm rounded-[4px] w-fit"
                for="NumberOfScenarios"
              >
                Number of Scenarios
              </label>
              <div className="flex justify-between">
                <select
                  className="border-1 rounded-large p-1 w-[40%]"
                  name="LinkedTransactions"
                  id="LinkedTransactions"
                >
      ...
      <div
        className="bg-white flex flex-col w-full overflow-x-auto gap-4 mb-7 rounded-large"
        style={{ padding: "30px 30px 30px 30px" }}
      >
        ...
        <div className="flex flex-row justify-between">
          <div className="flex items-center whitespace-nowrap gap-2">
            ...
            <button
              className="bg-gray-400 text-white rounded-large flex justify-center items-center gap-2"
              style={{
                padding: "10px 20px",
                lineHeight: "24px",
                color: "#fff",
          ...
          <div className="flex items-center">
            <p className="flex items-center" style={{ marginLeft: "auto" }}>
              1 to 50 from 1500+ transactions{" "}
              <GoChevronLeft className=" ml-2 pr-1" />{" "}
              <GoChevronRight className="pl-1" />
            </p>
          </div>
        </div>
          ...
          <thead>
            <tr>
              {TableHead.map((element, index) => {
                ...
                const textAlign = centerAlignedColumns.includes(element)
                  ? "text-center"
                  : "text-start";
                if (element === "")
                  return (
                ...
                <tr className={backgroundColorClass} style={{}}>
                  ...
                  >
                    <input
                      ...
                      style={{ lineHeight: "unset", verticalAlign: "top" }}
                      type="checkbox"
                    ></input>
                  </th>
                  {Object.entries(data).map(([key, value]) => {
                    ...
                    return (
                      <td
                        key={key}
                        className={`text-ssm whitespace-nowrap ${textAlignClass} px-1 ${textColorClass}`}
                        style={{
                          display: "table-cell",
                          unicodeBidi: "isolate",
                          lineHeight: "unset",
